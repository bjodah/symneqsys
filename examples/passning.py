...
class LangmuirSys(SimpleNEQSys):
    ...
    def exprs(self):
        ...
        return [K*c[i]*S[i]*alpha/(1+K*c[i])-c[i]-self.c0 for i,d in enumerate(self.data)]
...
if __name__ == '__main__':
    print('='*30)
    print('Ru(bipy)3')
    main(LangmuirSys, 1.68e-5, [(1.68e-5, 0), (1.62e-5, 1.665e-4), (1.46e-5, 3.49e-4)])
    print('-'*30)
    print('MB')
    main(LangmuirSys, 5.4e-6, [(5.4e-6, 0), (3.34e-6, 1.875e-4), (3.51e-6, 3.445e-4), (2.2e-6, 6.99e-4)])
